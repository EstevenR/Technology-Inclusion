      ...
      <DialogContent className="sm:max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <Select name="main_objective" required onValueChange={setObjetivo}>
              <SelectTrigger id="main_objective">
                <SelectValue placeholder="Selecciona un objetivo..." />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="Reducir tiempo manual">Reducir tiempo manual</SelectItem>
                <SelectItem value="Disminuir errores">Disminuir errores</SelectItem>
                <SelectItem value="Mejorar comunicacion con clientes">Mejorar la comunicación con clientes</SelectItem>
